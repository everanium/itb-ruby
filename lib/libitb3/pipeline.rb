...
module ITB
  ...
  # libitb3; #free releases the Go-side handle (a GC finalizer covers
  ...
  class Pipeline
    ...
    # the URL-query grammar libitb3 validates. The session blob is
    ...
    # string. The binding performs no validation -- libitb3 rejects
    ...
    # count out. +cap+ is the write ceiling libitb3 honours, so it
